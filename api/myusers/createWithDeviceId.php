...
if(
    ...
    $myusers->device_id=$data->device_id;
    ...
    if($stmt1->rowCount() > 0){
        ...
        curl_setopt_array($curl, array(
          CURLOPT_URL => "https://api.msg91.com/api/v5/otp?authkey=328462AhtDpV27Br5ece5f0aP1&template_id=5ece67d0d6fc0559043ddb3a&extra_param=&mobile=". $data->mobil ."",
