...
// set ID property of comments to be edited
$comments->comment_id = $data->comment_id;


// set comments property values
$comments->quote = $data->quote;
...
$comments->user_id = $data->user_id;
    ...
    //if unable to update the comments tell the user
    else{
        //set response code - 503 service unavailable
        http_response_code(503);

        //tell the user
        echo json_encode(array("message"=>"Unable to update Comments"));
    }
