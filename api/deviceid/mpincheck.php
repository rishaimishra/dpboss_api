...
if(
    ...
    $sql_m="SELECT * FROM devicestatus WHERE device_id='$deviceid->device_id' and devicestatus.status=1";
// echo $sql_m;die;
    ...
    if($stmt1->rowCount() > 0){
        ...
        // echo $row['username'];
         ...
         echo json_encode(array("version"=>"1","response"=>"Success","message"=>"True"));
        ...
        if ($stmt2->rowCount() > 0) {
             ...
             echo json_encode(array("response"=>"Failed","message"=>"Your Mpin is Blocked"));
            ...
            echo json_encode(array("response"=>"Failed","message"=>"Please register the Mpin first"));
